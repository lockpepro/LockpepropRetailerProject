...
class CustomerListingV2Response {
  final bool success;
  final String role;
  final int count;
  final int enrolled;
  ...
  final int limit;
  final List<CustomerListingV2Item> data;

  CustomerListingV2Response({
  ...
  factory CustomerListingV2Response.fromJson(Map<String, dynamic> json) {
    return CustomerListingV2Response(
      ...
      data: (json["data"] as List? ?? [])
          .map((e) => CustomerListingV2Item.fromJson(Map<String, dynamic>.from(e)))
          .toList(),
    );
  }
}

class CustomerListingV2Item {
  final String id;
  final String? userId;
  ...
  final CustomerListingV2Emi? emi;
  ...
  factory CustomerListingV2Item.fromJson(Map<String, dynamic> json) {
    return CustomerListingV2Item(
      ...
      emi: json["emi"] is Map<String, dynamic>
          ? CustomerListingV2Emi.fromJson(Map<String, dynamic>.from(json["emi"]))
          : null,
...
class CustomerListingV2Emi {
  ...
  factory CustomerListingV2Emi.fromJson(Map<String, dynamic> json) {
    return CustomerListingV2Emi(
